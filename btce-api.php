...
class BTCeAPI {
    ...
    protected $public_api = 'https://wex.nz/api/2/';
    ...
    public function getPairTrades($pair) {
        return $this->retrieveJSON($this->public_api.$pair."/trades/1");
    }
    ...
    public function getPairDepth($pair) {
        return $this->retrieveJSON($this->public_api.$pair."/depth/2");
    }
}
